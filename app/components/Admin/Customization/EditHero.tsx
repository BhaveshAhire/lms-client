...
const EditHero: FC<Props> = (props: Props) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      console.log("bannerImage", data?.layout?.banner?.image?.url);
    }
    if (isSuccess) {
      refetch();
        ...
        <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
          <div className="relative flex items-center justify-end">
            ...
            <label htmlFor="banner" className="absolute bottom-0 right-0 z-20">
              <AiOutlineCamera className="dark:text-red-900 text-black text-[18px] cursor-pointer" />
            </label>
          </div>
        </div>
  ...
  leading-[1.2] text-right bg-transparent outline-none focus:ring-0 focus:outline-none"
          ...
          <textarea
            ...
            placeholder="We have 40k+ Online courses & 500k+ Online registered students. Find your desired courses now."
            className="dark:text-[#edfff4] text-[#000000ac] font-josefin font-[600] text-[18px] 
  leading-[1.5] text-right w-full 1500px:!w-[55%] 1100px:!w-[70%] bg-transparent outline-none focus:ring-0 focus:outline-none"
